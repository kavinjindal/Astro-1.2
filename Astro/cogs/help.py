...
cd.add_field(name = 'Economy Commands', value='`bal, shop, bag, buy [item_name] [amount], give [@user] [amount from bank], withd [amount], dep [amount], sell [item_name] [amount], beg, work, daily, lb`', inline=False)
