...
class Start(commands.Cog):
    ...
    async def bet(self, ctx, amount= None):
      ...
      if amount<0:
          ...
          return
      bet_function = [amount*amount, 0/amount, amount*10, amount*50, amount*2, amount*5, amount*3, amount*4]
      ren_bet = random.choice(bet_function)
      await update_bank(ctx.author,-1*amount,"Wallet")
      await update_bank(ctx.author,ren_bet, "Wallet")
      
      
      

      await ctx.send(f'You bet {amount} coins and got {ren_bet} coins')
    ...
    async def work(self, ctx):
        ...
        options = [f'You worked as a sweeper and earned {earnings} coins', f'You worked as a Police Officer and earned {earnings} coins', f'You worked as a film director and earned {earnings} coins', 
        f'You are lazy and u get nothing', f'Go do some real work to earn', f'You worked as a robber and got {earnings} coins', f'You worked as a Python Programmer in a startup and earned {earnings} coins']
